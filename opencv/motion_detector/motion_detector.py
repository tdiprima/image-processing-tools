...
TODO: This is broken. You get an infinite window effect.
Open a video in YouTube - this script records your screen.
https://www.youtube.com/watch?v=-ya9gszERU0
"""
import cv2
import numpy as np
...
def motion_detector():
    ...
    while True:
        ...
        # 3a. Set previous frame and continue if there is None
        if previous_frame is None:
            # First frame; there is no previous one yet
            previous_frame = prepared_frame
            continue

        # 3b. calculate difference and update previous frame
        diff_frame = cv2.absdiff(src1=previous_frame, src2=prepared_frame)
        previous_frame = prepared_frame

        # 4. Dilute the image a bit to make differences more see-able; more suitable for contour detection
        kernel = np.ones((5, 5))
